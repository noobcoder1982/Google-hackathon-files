         ...
         <div className="flex-1 overflow-y-auto scrollbar-hide p-10 space-y-10">
            {(searchQuery ? filteredMessages : messages).map((msg, i) => (
                  <motion.div 
                    ...
                    className={cn("flex gap-6 max-w-4xl", msg.isSystem ? 'bg-indigo-600/[0.03] p-8 rounded-[2.5rem] border border-indigo-600/10 shadow-sm relative overflow-hidden' : '')}
                  >
                     <div className="h-14 w-14 rounded-2xl bg-secondary flex items-center justify-center border border-border shrink-0 font-black uppercase">
                        {msg.user[0]}
                     </div>
                     <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-2.5">
                           <span className="text-base font-bold text-foreground">{msg.user}</span>
                        ...
                        <Markdown content={msg.content} className={cn("text-base leading-relaxed tracking-tight", msg.isSystem ? 'text-foreground font-semibold italic' : 'text-muted-foreground font-medium')} />
                   ...
                   <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                         <div className="flex items-center gap-4 p-4 rounded-2xl bg-secondary/40 border border-border/50">
                            <div className="h-10 w-10 rounded-xl bg-indigo-600/10 flex items-center justify-center text-indigo-600"><Crown className="h-5 w-5" /></div>
                            <div className="flex-1">
                               <div className="text-xs font-bold">ImpactQuest AI</div>
                               <div className="text-[9px] font-black text-indigo-600 uppercase">System Owner</div>
                            </div>
                         </div>
